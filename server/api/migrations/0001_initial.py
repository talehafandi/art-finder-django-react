# Generated by Django 4.1 on 2024-03-12 15:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forgot_pass_otp', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MaxValueValidator(999999)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('venue_category', models.CharField(blank=True, choices=[('MU', 'MUSEUM'), ('GA', 'GALLERY')], max_length=2)),
                ('lat', models.DecimalField(decimal_places=6, max_digits=9)),
                ('long', models.DecimalField(decimal_places=6, max_digits=9)),
                ('hosting_events', models.ManyToManyField(null=True, related_name='hosts', to='api.eventmodel')),
            ],
        ),
        migrations.CreateModel(
            name='WishlistModel',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('events', models.ManyToManyField(null=True, related_name='wishlists', to='api.eventmodel')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('venues', models.ManyToManyField(null=True, related_name='wishlists', to='api.venuemodel')),
            ],
        ),
        migrations.CreateModel(
            name='ItineraryModel',
            fields=[
                ...
                ('venues', models.ManyToManyField(null=True, related_name='itineraries', to='api.venuemodel')),
            ],
        ),
        migrations.CreateModel(
            name='BookingModel',
